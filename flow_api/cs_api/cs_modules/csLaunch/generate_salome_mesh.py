...
if (dom == 0):
 ...
 part = geompy.MakePartition([bande], [temp], [], [], geompy.ShapeType["FACE"], 0, [], 0)
...
isDone = Maillage_1.Compute()
(Group, error) = Maillage_1.ExtrusionAlongPathObjects( [ Maillage_1 ], [], [ Maillage_1 ], path, None, 1, 0, [  ], 0, 0, [ 0, 0, 0 ], 1, [  ], 0 )
