...
u_std = u.resample(time='10T').std()  # Calculate the standard deviation over the intervals
...
plot_variable(ds_combined['wind_direction'], 'Wind Direction', 'degrees', 'wind_direction_plot')
plot_variable(ds_combined['turbulence_intensity'], 'Turbulence Intensity', 'ratio', 'turbulence_intensity_plot')
plot_variable(ds_combined['potential_temperature'], 'Potential Temperature', 'K', 'potential_temperature_plot')
plot_variable(ds_combined['turbulence_intensity'], 'Turbulence Intensity (TI)', 'ratio', 'TI_plot')
